...
A simple script to unsubscribe from all YouTube channels quickly using the browser console.
...
4. Press Enter and let the browser suffer for your past decisions
